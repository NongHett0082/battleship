...
// ✅ Socket.io Configuration สำหรับ Production (Render)
...
// ✅ ใช้ PORT จาก environment variable โดยตรง (Render จะกำหนดให้)
const PORT = process.env.PORT || 3000;

// ✅ CSP Header ที่อนุญาต WebSocket และ Socket.io
...
// ✅ Routes สำหรับ HTML pages (แก้ปัญหา Cannot GET)
app.get('/', (req, res) => {
